...
const createOwner = (req: Request, res: Response) => {
  ...
  (async () => {
    try {
      ...
      const query = `INSERT INTO Owner (email, password, owner_name, owner_birth, owner_gender, profile_picture) VALUES ('${email}', '${hashedPassword}', '${name}', '${birth}', '${gender}', '${profile_picture}')`;
